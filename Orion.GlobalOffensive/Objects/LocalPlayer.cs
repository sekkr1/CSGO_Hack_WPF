...
namespace Orion.GlobalOffensive.Objects
{
    ...
    public class LocalPlayer : BaseEntity
    {
        ...
        ///     The view matrix.
        /// </value>
        public Matrix4x4 ViewMatrix => Orion.Memory.Read<Matrix4x4>(Orion.ClientBase + (int)BaseOffsets.ViewMatrix);
        ...
        {
            get { return ReadField<float>(StaticOffsets.FlashMaxAlpha); }
            set { WriteField(StaticOffsets.FlashMaxAlpha, value); }
        }
