namespace CSGO_Hack_WPF.SDK
{
    public static class NetVars
    {
        ...
        {
            public static int ItemIdHigh = 0x2FA0;
            public static int OriginalOwnerXuidLow = 0x3168;
            public static int OriginalOwnerXuidHigh = 0x316C;
            public static int FallbackPaintKit = 0x3170;
