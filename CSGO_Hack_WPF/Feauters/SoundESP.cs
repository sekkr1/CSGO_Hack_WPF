...
namespace CSGO_Hack_WPF.Feauters
{
    public class SoundEsp
    {
        ...
        {
         /*   _enabled = Properties.Settings.Default.sound;
            _range = Properties.Settings.Default.soundRange;
            _interval = Properties.Settings.Default.soundInterval;
            _volume = Properties.Settings.Default.soundVolume;*/
        }
        #endregion
    }
}