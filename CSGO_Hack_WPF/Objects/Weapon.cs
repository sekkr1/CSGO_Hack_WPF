...
namespace CSGO_Hack_WPF.Objects
{
    public class Weapon : BaseEntity
    {
        ...
        public int OwnerXuidLow => ReadField<int>(NetVars.Misc.OriginalOwnerXuidLow);
        public string WeaponName => System.Text.RegularExpressions.Regex.Replace(((ItemDefinitionIndex)WeaponId).ToString(),"^Knife(.*)","").Replace("_"," ");
