...
namespace CSGO_Hack_WPF.Objects
{
    ...
    public class BaseEntity : NativeObject
    {
        ...
        public Vector3 VecMin => ReadField<Vector3>(Offsets.BaseEntity.VecMin);
        public Vector3 VecMax => ReadField<Vector3>(Offsets.BaseEntity.VecMax);
        public float Distance => Vector3.Distance(Core.LocalPlayer.Position, Position);
        public float DistanceSquared => Vector3.DistanceSquared(Core.LocalPlayer.Position, Position);
        public float DistanceMeters => Distance * 0.01905f;
